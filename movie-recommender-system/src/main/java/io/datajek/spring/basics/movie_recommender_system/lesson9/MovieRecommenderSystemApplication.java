...
@ComponentScan(basePackages={"io.datajek.spring.basics.movie_recommender_system.lesson10"})
@ComponentScan(includeFilters = @ComponentScan.Filter(type = FilterType.REGEX,pattern = "io.datajek.spring.basics.movie_recommender_system.lesson09.*"))
